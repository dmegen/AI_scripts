...
feature_data          = '/glade/work/hardt/data/model2/v6/model2-v6_00minuteAfterHour_3D_refl_shuffled_scaled.nc'
label_data            = '/glade/work/hardt/data/model2/v6/model2-v6_composite_W_shuffled_scaled.nc'

from unet_model_v6p0_3 import unet
...
neptune_experiment_name = 'v6p0_3 ref00minAfter Wcomp thresh reflComp_-35.0'
neptune_upload_source_files = ['train-unet_model_v6p0_3.py', 'unet_model_v6p0_3.py']
neptune_tags = ['v6p0_3', '0minOffset', 'Shuffled','CustomLoss', 'Adam', 'unet']
