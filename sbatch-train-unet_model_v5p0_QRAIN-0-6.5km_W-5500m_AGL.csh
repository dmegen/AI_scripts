...
#SBATCH --job-name=v5p0_train_model
...
#SBATCH --exclusive
#SBATCH --output=train-unet_model_v5p0_QRAIN-0-6.5km_W-5500m_AGL.log_job_%j

#set CUDA_VISIBLE_DEVICES = 1 
set TF_FORCE_GPU_ALLOW_GROWTH=true

set output_root_dir = /glade/work/hardt/models
set model_run_name  = unet_v5p0
set script = train-unet_model_v5p0_W_5500AGL
set model = unet_model_v5p0
