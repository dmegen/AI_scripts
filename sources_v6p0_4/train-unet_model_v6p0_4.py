...
from unet_model_v6p0_4 import unet
...
neptune_experiment_name = 'v6p0_4 ref00minAfter Wcomp thresh reflComp_-35.0'
neptune_upload_source_files = ['train-unet_model_v6p0_4.py', 'unet_model_v6p0_4.py']
neptune_tags = ['v6p0_4', '0minOffset', 'Shuffled','CustomLoss', 'Adam', 'unet']
