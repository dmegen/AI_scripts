...
#SBATCH --output=predict-unet_model_v3p0_QRAIN_W_2000_AGL.log_job_%j

set output_root_dir = /glade/work/hardt/models
set model_run_name  = unet_v3p0
set script = predict-unet_model_v3p0
