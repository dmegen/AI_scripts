...
neptune.create_experiment(name='14channel-W-5.5km 501-600 epochs', 
                          params=PARAMS,
                          tags=['Adam'],
)
...
previous_model = 'trained_model_feature-0to6.5km_at_500m_steps_label-5500m_2020_11_21_17_43.h5'
