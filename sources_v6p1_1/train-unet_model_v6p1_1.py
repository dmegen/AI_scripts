...
def mae(y_true, y_pred):
    y_true2 = y_true[y_true > -89.9]
    y_pred2 = y_pred[y_true > -89.9]
    eval = K.abs(y_pred2 - y_true2)
...
from unet_model_v6p1_1 import unet
...
neptune_experiment_name = 'v6p1_1 ref05minAfter Wcomp thresh 0.001'
neptune_upload_source_files = ['train-unet_model_v6p1_1.py','unet_model_v6p1_1.py']
neptune_tags = ['v6p1_1', '5minOffset', 'Shuffled','CustomLoss', 'Adam', 'unet']
...
PARAMS = {'epochs': 100,
          ...
          'model_run_name': 'unet_v6p1',
          'feature_description': '05minAfterHour_refl',
          }
