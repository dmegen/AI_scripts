...
feature_data          = '/glade/work/hardt/ds612/model2_10minuteAfterHour_3D_refl_shuffled_scaled-v6.nc'
label_data            = '/glade/work/hardt/ds612/model2_composite_W_shuffled_scaled-v6.nc'

from unet_model_v6p2_3 import unet
...
neptune_experiment_name = 'v6p2_3 ref10minAfter Wcomp thresh reflComp_-35.0'
neptune_upload_source_files = ['train-unet_model_v6p2_3.py', 'unet_model_v6p2_3.py']
neptune_tags = ['v6p2_3', '10minOffset', 'Shuffled','CustomLoss', 'Adam', 'unet']
