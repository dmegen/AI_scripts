...
#SBATCH --job-name=v6p2_3_train_model
...
#SBATCH --exclusive
#SBATCH --output=train-unet_model_v6p2_3.log_job_%j
...
set model_run_name  = unet_v6p2
set script = train-unet_model_v6p2_3
set model = unet_model_v6p2_3
