...
from unet_model_v6p1_3 import unet
...
neptune_experiment_name = 'v6p1_3 ref05minAfter Wcomp thresh reflComp_-35.0'
neptune_upload_source_files = ['train-unet_model_v6p1_3.py', 'unet_model_v6p1_3.py']
neptune_tags = ['v6p1_3', '5minOffset', 'Shuffled','CustomLoss', 'Adam', 'unet']
