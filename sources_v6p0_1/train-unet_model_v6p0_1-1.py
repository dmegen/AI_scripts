...
feature_data          = '/glade/work/hardt/data/model2/v2/model2-v2_00minuteAfterHour_3D_refl_shuffled.nc'
label_data            = '/glade/work/hardt/data/model2/v2/model2-v2_3D_W_shuffled.nc'

from unet_model_v6p0_1 import unet
...
neptune_experiment_name = 'v6p0_1 ref00minAfter Wcomp thresh 0.001'
neptune_upload_source_files = ['train-unet_model_v6p0_1.py','unet_model_v6p0_1.py']
neptune_tags = ['v6p0_1', '0minOffset', 'Shuffled','CustomLoss', 'Adam', 'unet']
