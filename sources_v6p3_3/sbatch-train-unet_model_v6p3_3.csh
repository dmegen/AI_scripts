...
#SBATCH --job-name=v6p3_3_train_model
...
#SBATCH --exclusive
#SBATCH --output=train-unet_model_v6p3_3.log_job_%j
...
set model_run_name  = unet_v6p3
set script = train-unet_model_v6p3_3
set model = unet_model_v6p3_3
